    ...
    private var permissionDenied: some View {
        VStack(spacing: 18) {
            ...
            Text("Camera Access Needed")
                .font(.title2.bold())
                .foregroundStyle(.white)
            Text("Trial needs camera and microphone access to record your Trials. Enable it in Settings.")
                .font(.subheadline)
    ...
    private var simulatorPlaceholder: some View {
        VStack(spacing: 18) {
            ...
            Text("Trial Camera")
                .font(.title2.bold())
                .foregroundStyle(.white)
            Text("Install this app on your device via the Rork App to record Trials.")
                .font(.subheadline)
                .foregroundStyle(Theme.textMuted)
                .multilineTextAlignment(.center)
        }
